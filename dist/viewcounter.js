...
router.post('/increment-view', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // Check if the 'viewedShop' cookie is set
        if (!req.cookies.viewedShop) {
            // Insert a new view record with the current timestamp
            const [results] = yield pool.query('INSERT INTO Shopviews (view_count, view_date) VALUES (1, NOW())');
...
router.get('/metrics', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const [totalViewsResults] = yield pool.query(totalViewsQuery);
        ...
        const viewsByMonthQuery = `
            ...
            ORDER BY 
                MONTH(view_date)
        `;
        const [viewsByMonthResults] = yield pool.query(viewsByMonthQuery);
